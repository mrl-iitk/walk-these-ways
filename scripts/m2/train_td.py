...
def train_m2(cfg: dict):
    ...
    from go1_gym_learn.tdmpc import Runner
    ...
    from go1_gym_learn.tdmpc.common.parser import parse_cfg
    from go1_gym_learn.tdmpc.common.seed import set_seed
    config_m2(Cfg)
    ...
    gpu_id = 0
    runner = Runner(env, cfg, device=f"cuda:{gpu_id}")
    runner.train()
