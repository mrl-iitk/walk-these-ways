...
def config_m2(Cnfg: Union[Cfg, Meta]):
    ...
    _ = Cnfg.asset
    # _.file = '/home/xterra/walk-these-ways/resources/robots/m2/urdf1/SVANM2_URDF_simple.urdf'
    _.file = '/home/xterra/walk-these-ways/resources/robots/m2/urdf1/svan_m2_metal_collision_simplified.urdf'
    _.foot_name = "foot"
    _.penalize_contacts_on = ["thigh", "shank"]
